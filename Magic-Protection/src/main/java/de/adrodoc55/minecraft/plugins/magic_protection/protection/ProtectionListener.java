...
public class ProtectionListener implements Listener {
	...
	private void blockAttacked(Block block, Player player, Cancellable e,
	...
	public void blockExploded(EntityExplodeEvent e) {
		...
		for (Block block : explodingBlocks) {
			OfflinePlayer protector = ProtectionManager
	...
	public void inventoryOpened(InventoryOpenEvent e) {
		...
		if (inventoryHolder instanceof DoubleChest) {
			...
			OfflinePlayer leftProtector = ProtectionManager
					.getBlockProtector(left);
			OfflinePlayer rightProtector = ProtectionManager
					.getBlockProtector(right);
			if (leftProtector == null) {
				...
				if (rightProtector == null) {
					...
					if (!rightProtector.equals(leftProtector)) {
						String format = "Es gibt zwei verschiedene Beschützer für die Doppel-Kiste '%s'. Daher wird der Rechte genommen";
