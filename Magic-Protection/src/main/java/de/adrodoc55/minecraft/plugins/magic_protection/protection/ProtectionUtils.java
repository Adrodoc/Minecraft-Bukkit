...
public class ProtectionUtils {
  ...
  public static short getIdOfBlock(Block block) {
    ...
    if (id > Short.MAX_VALUE || id < 0) {
      String message = String.format(
          "Die Id eines Blocks muss in einen Short passen, war aber '%d'! Möglicherweise ist die Welt höher als 128 Blöcke und die Protection Kodierung muss angepasst werden.",
          id);
  ...
  public static String getNameOfChunk(Chunk chunk) {
    ...
    String nameOfChunk =
        String.valueOf(chunk.getX()) + CHUNK_NAME_SEPARATOR + String.valueOf(chunk.getZ());
    return nameOfChunk;
  }
