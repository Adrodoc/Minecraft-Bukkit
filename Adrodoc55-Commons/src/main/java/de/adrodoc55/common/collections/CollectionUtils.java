...
//		E[] result = (E[]) new Object[elements.length - nullCount];
	...
	/**
	 * Iterates through this iterable transforming each entry into a new value
	 * using the transform closure returning a list of transformed values.
	 * 
	 * @param iterable
	 * @param transform
	 ...
	 */
	public static <P, R> List<R> collect(Iterable<? extends P> iterable,
			Closure<P, R> transform) {
	 ...
	 */
	public static <P> List<P> findAll(Iterable<? extends P> iterable,
			Closure<P, Boolean> closure) {
