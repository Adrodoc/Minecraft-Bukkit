...
public class ValidationException extends RuntimeException {
  ...
  /**
   * Constructs a new ValidationException with {@code null} as its detail message. The cause is not
  ...
  /**
   * Constructs a new ValidationException with the specified detail message. The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   *
  ...
  /**
   * Constructs a new ValidationException with the specified detail message, cause, suppression
