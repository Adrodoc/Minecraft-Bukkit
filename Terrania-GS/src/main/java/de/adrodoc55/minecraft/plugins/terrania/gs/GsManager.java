...
public class GsManager {
  ...
  public void save() {
    try {
      ...
      String errorMessage =
          String.format("JAXBException beim Speichern des GSManagers für Welt '%s' mit UUID '%s'",
  ...
  private static GsManager load(World world) {
    ...
    try {
      ...
      String errorMessage =
          String.format("JAXBException beim Laden des GSManagers für Welt '%s' mit UUID '%s'",
              worldName, worldUuid);
  ...
  /**
   * Findet das Grundstück, falls es existiert und gibt es zurück. Ansonsten wird null
   * zurückgegeben.
   *
   * @param sign - das Sign des Grundstückes nach dem gesucht werden soll.
   ...
   * zurückgegeben.
   *
   * @param gsName - der Name des Grundstückes nach dem gesucht werden soll.
   * @return das Grundstück oder null.
   */
  ...
  /**
   * Fügt das Grundstück dem passenden GSManager hinzu, falls das Element noch nicht enthalten ist.
   * <br>
   * <br>
   * Siehe {@link Set#add Set.add}
   *
   * @param grundstueck
   * @throws ValidationException wenn das Grundstück invalide ist.
  ...
  public static boolean add(Grundstueck grundstueck) throws ValidationException {
    ...
    if (find != null) {
      String message =
          String.format("Dieses Schild wird bereits vom Grundstück %s verwendet", find.getName());
  ...
  /**
   * Entfernt das Grundstück von dem passenden GSManager, falls das Element enthalten ist. <br>
