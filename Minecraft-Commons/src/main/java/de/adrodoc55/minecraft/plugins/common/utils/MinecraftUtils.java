...
public class MinecraftUtils {
	...
	/**
	 * Sendet eine Nachricht an den Spieler, falls in den letzten 9 Sekunden
	 * nicht die selbe Nachricht bereits an diesen Spieler geschickt wurde.
	 * 
	...
	public static void sendInfo(final CommandSender commandSender,
			String message) {
		sendMessage(commandSender, ChatColor.YELLOW + message);
	}

	public static void sendError(final CommandSender commandSender,
			String message) {
