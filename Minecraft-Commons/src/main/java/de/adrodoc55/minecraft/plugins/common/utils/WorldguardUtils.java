...
public class WorldguardUtils {
	...
	/**
	 * Durchsucht alle Welten nach dieser Region und liefert die erste Welt
	 * zurüch, in der die Region gefunden wurde. Ansonsten null.
	 * 
	...
	public static World getWorldOfRegion(ProtectedRegion region) {
		...
		for (World world : worlds) {
			RegionManager regionManager = worldGuardPlugin
