...
public class MaterialUtils {
  ...
  public static boolean isDependened(Material material) {
    return isStanding(material) || isFourDirectional(material) || isSixDirectional(material)
        || isEightDirectional(material) || isTwelveDirectional(material);
  }

  public static boolean isLockable(Material material) {
    return hasInventory(material) || isDoor(material) || isTrapDoor(material);
  }
  ...
  private static Block getBlockDependency(Block block) {
    ...
    String message =
        String.format("Invalide Block-Data eines hängenden Blocks: Block = '%s'", block);
